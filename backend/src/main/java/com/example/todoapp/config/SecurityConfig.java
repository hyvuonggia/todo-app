...
public class SecurityConfig {
    ...
    /**
     * Creates a custom authentication entry point that returns 401 Unauthorized
     * instead of 403 Forbidden for authentication failures.
     *
     * @return the AuthenticationEntryPoint instance
     */
    @Bean
